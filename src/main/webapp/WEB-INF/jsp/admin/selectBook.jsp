        ...
        <tr valign="top">
            <td width="145px" style="padding-left: 20px">
                <ul class="nav nav-pills nav-stacked" style="width:120px">
                    <li role="presentation" class="active" style="width:100%"><a href="#">管理全部书籍</a></li>
            ...
            <td align="left" style="padding-left: 40px;padding-right: 40px">
                <div>
                    <h3 style="display: inline">图书列表
                        <a href="/admin/books/add" type="button" class="btn btn-primary btn-sm">添加</a>
                        <a href="/admin/books" type="button" class="btn btn-primary btn-sm">返回所有图书</a>
                    </h3>
